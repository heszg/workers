...
public class WorkerHireScreen extends ScreenBase<WorkerHireContainer> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        // Titles
        guiGraphics.drawString(font, worker.getDisplayName().getVisualOrderText(), 8, 5, fontColor);
        guiGraphics.drawString(font, player.getInventory().getDisplayName().getVisualOrderText(), 8,
                this.imageHeight - 96 + 2, fontColor);

        // Info
        guiGraphics.drawString(font, "Hp:", k, l, fontColor);
        guiGraphics.drawString(font, "" + health, k + 40, l, fontColor);

        guiGraphics.drawString(font, "MaxHp:", k, l + 10, fontColor);
        guiGraphics.drawString(font, "" + maxHealth, k + 40, l + 10, fontColor);

        guiGraphics.drawString(font, "Speed:", k, l + 20, fontColor);
        guiGraphics.drawString(font, "" + decimalformat.format(speed), k + 40, l + 20, fontColor);

        guiGraphics.drawString(font, "Hunger:", k, l + 30, fontColor);
        guiGraphics.drawString(font, "" + hunger, k + 40, l + 30, fontColor);

        guiGraphics.drawString(font, "Costs:", k, l + 40, fontColor);
        guiGraphics.drawString(font, "" + costs, k + 40, l + 40, fontColor);
